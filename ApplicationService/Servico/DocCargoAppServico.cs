...
{
    public class DocCargoAppServico : BaseServico<DocumentoCargo>, IDocCargoAppServico
    {
        private readonly IDocCargoRepositorio _docCargoRepositorio;

        public DocCargoAppServico(IDocCargoRepositorio docCargoRepositorio) : base(docCargoRepositorio)
        {
