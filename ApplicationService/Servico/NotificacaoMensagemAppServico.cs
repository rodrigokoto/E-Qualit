...
{
    public class NotificacaoMensagemAppServico : BaseServico<NotificacaoMensagem>, INotificacaoMensagemAppServico
    {
        ...
        public NotificacaoMensagemAppServico(INotificacaoMensagemRepositorio notificacaoMensagemRepositorio,
                                          INotificacaoRepositorio notificacaoServico,
                                          IRegistroConformidadesRepositorio registroConformidadeRepositorio) : base(notificacaoMensagemRepositorio)
        {
