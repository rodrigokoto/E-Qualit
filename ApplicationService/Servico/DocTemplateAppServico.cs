...
{
    public class DocTemplateAppServico : BaseServico<DocTemplate>, IDocTemplateAppServico
    {
        private IDocTemplateRepositorio _docTemplateRepositorio;

        public DocTemplateAppServico(IDocTemplateRepositorio docTemplateRepositorio) : base(docTemplateRepositorio)
        {
