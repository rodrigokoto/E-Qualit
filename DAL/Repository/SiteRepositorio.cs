...
{
    public class SiteRepositorio : BaseRepositorio<Site>, ISiteRepositorio
    {
        public IEnumerable<Site> ListarSitesPorCliente(int idCliente)
        {
            return Db.Site.Where(x => x.Cliente.IdCliente == idCliente);
        }
                ...
                using (var dbContextTransaction = context.Database.BeginTransaction())
                {
                    ...
                    {                        
                        ...
                        foreach (var item in sites)
                        {
                            ...
                            var usuariosClientesSites = context.UsuarioClienteSite.Where(x => x.IdSite == item.IdSite).ToList();
