                ...
                switch (form) {
                    case "analisecritica":
                        ...
                        else if (analiseCriticaObj.Temas.length == 0)
                        {
                            ...
                            else if ((analiseCriticaObj.Temas[0].GestaoDeRisco.IdResponsavelInicarAcaoImediata == null || analiseCriticaObj.Temas[0].GestaoDeRisco.IdResponsavelInicarAcaoImediata == "") && analiseCriticaObj.Temas[0].PossuiGestaoRisco == "true") {
