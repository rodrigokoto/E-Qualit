...
APP.controller.NormaController = {
    ...
    setNewNormaFormNorma : function () {
        ...
        this.buttonAddNewNormaFormNorma.on('click', function () {
            ...
            html += '<i class="fa fa-pencil" aria-hidden="true" data-toggle="tooltip" data-original-title="@Traducao.Resource.btn_lbl_editar"></i>';
            html += '</a>';
            ...
            html += '<i class="fa fa-circle" aria-hidden="true" data-toggle="tooltip" data-original-title="@Traducao.Resource.btn_lbl_desativar"></i>';
            html += '</a>';
            html += '</td>';
            html += '</tr>';
