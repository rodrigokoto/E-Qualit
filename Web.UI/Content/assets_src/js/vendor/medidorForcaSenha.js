...
(function(a) {
    a.extend(a.fn, {pstrength:function(b) {
        var b = a.extend({verdects:["Fraca","Média","Forte","Muito forte"],colors:["#c06","#f60","#3c0","#3d0"],scores:[10,15,30,40],common:["password","sex","god","123456","123", "12345", "1234", "12", "123456789", "1234567", "12345678" ,"liverpool","letmein","qwerty","monkey"],minchar:5}, b);
