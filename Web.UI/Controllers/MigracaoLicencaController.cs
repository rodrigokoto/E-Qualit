...
namespace Web.UI.Controllers
{
    ...
    public class MigracaoLicencaController : BaseController
    {
        ...
        public MigracaoLicencaController(ILicencaAppServico licencaAppServico,
        ...
        public JsonResult Criar(Licenca licenca)
        {
            ...
            try
            {
                ...
                var usuario = _usuarioAppServico.GetById(licenca.IdResponsavel);

                var cliente = _siteAppServico.GetById(licenca.Idcliente);

                licenca.Idcliente = cliente.IdCliente;
            ...
            catch (Exception ex)
            {
                ...
                return Json(new { StatusCode = 417, Erro = erros }, JsonRequestBehavior.AllowGet);
                throw;
            }
        }
