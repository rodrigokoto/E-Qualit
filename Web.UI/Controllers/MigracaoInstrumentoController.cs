...
{
    public class MigracaoInstrumentoController : BaseController
    {
        ...
        public MigracaoInstrumentoController(IInstrumentoAppServico instrumentoAppServico,
        ...
        public JsonResult Criar(Instrumento instrumento)
        {
            ...
            var InstrumentoNumber = _instrumentoAppServico.Get(i => i.IdSigla == instrumento.IdSigla).LastOrDefault();

            if (InstrumentoNumber == null)
            {
                instrumento.Numero = 1;
            }
            else
            {
                instrumento.Numero = InstrumentoNumber.Numero + 1;
            }
