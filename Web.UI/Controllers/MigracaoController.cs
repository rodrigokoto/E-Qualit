...
namespace Web.UI.Controllers
{
    ...
    public class MigracaoController : BaseController
    {
        ...
        private readonly IControladorCategoriasAppServico _controladorCategoriasAppServico;
        ...
        public MigracaoController(IDocDocumentoAppServico docDocumentoAppServico,
                                    ...
                                    IControladorCategoriasAppServico controladorCategoriasAppServico,
        ...
        public JsonResult CriarSigla()
        {
            return Json(new { StatusCode = (int)HttpStatusCode.OK });
        }
        public JsonResult RetornaSigla()
        {
            return Json(new { StatusCode = (int)HttpStatusCode.OK });
        }
        public JsonResult VerificarSigla(string Sigla, string idSite)
        {
            if (Sigla != string.Empty)
            {
                ...
                {
                    var categoria = new ControladorCategoria()
                    {
                        Ativo = true,
                        IdSite = Convert.ToInt32(idSite),
                        TipoTabela = Sigla,
                        Descricao = "Isotec",
        ...
        public ActionResult Salvar(DocDocumento doc, bool validarAssunto = false)
        {
            ...
            switch ((StatusDocumento)doc.FlStatus)
            {
