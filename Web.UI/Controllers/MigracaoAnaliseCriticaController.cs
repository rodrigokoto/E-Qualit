...
{
    public class MigracaoAnaliseCriticaController : BaseController
    {
        ...
        public MigracaoAnaliseCriticaController(IAnaliseCriticaAppServico analiseCriticaAppServico,
