...
{
    public class DocumentoComentarioServico : IDocumentoComentarioServico
    {
        private IDocumentoComentarioRepositorio _documentoComentariorepositorio;

        public DocumentoComentarioServico(IDocumentoComentarioRepositorio documentoComentariorepositorio) 
        {
