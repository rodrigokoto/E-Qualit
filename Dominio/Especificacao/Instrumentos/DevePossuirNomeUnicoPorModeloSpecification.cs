...
{
    public class DevePossuirNomeUnicoPorModeloSpecification : ISpecification<Instrumento>
    {
        private readonly IInstrumentoRepositorio _repositorio;

        public DevePossuirNomeUnicoPorModeloSpecification(IInstrumentoRepositorio repositorio)
        {
        ...
        public bool IsSatisfiedBy(Instrumento instrumento)
        {
            ...
            {
                return _repositorio.Get(x => 
                                        x.Numero == instrumento.Numero &&                                        
