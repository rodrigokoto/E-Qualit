...
{
    public class AptoParaCadastroInstrumentoValidation : Validator<Instrumento>
    {
        public AptoParaCadastroInstrumentoValidation(IInstrumentoRepositorio repositorio)
        {
